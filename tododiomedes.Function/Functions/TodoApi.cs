...
using tododiomedes.common.Models;
using tododiomedes.common.Responses;
using tododiomedes.Function.Entities;

namespace tododiomedes.Function.Functions
{
    public static class TodoApi
    {
           ...
           ILogger log)
        {
            ...
            string message = "Retrieved all todo";
            log.LogInformation(message);
        ...
        public static async Task<IActionResult> DeleteTodo(
         ...
         ILogger log)
        {
            log.LogInformation($"Deleyte todo: {id}, received.");
